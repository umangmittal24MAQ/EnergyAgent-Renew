...
try:
    from app.agents.ingestion.loader import load_all, load_solar_last7_data
    from app.agents.ingestion.processor import build_unified_dataframe, compute_overview_kpis
