...
def build_energy_report_html(config: Dict[str, Any]) -> tuple:
    ...
    try:
        ...
        greeting_report_date = previous_day_cutoff.strftime("%d-%b-%Y")
                    ...
                    <tr>
                        <td align="center">
                            <table width="99%" cellpadding="0" cellspacing="0" style="max-width:1460px; border:1px solid #d9d9d9; background:#ffffff;">
                                ...
                                <tr>
                                    <td style="padding:16px 24px 12px 24px; font-size:15px; color:#1f2937;">
                                        Hello,<br><br>
                                        Below is the Energy Consumption Report for {greeting_report_date}.
                                    </td>
                                </tr>
                               <tr></tr>
                                <!-- HIDDEN FOR NOW - DO NOT REMOVE -->
                                <tr>
                                    <td style="display:none; padding:0 24px 10px 24px;">
                                ...
                                <!-- HIDDEN FOR NOW - DO NOT REMOVE -->
                                <tr>
                                    <td style="display:none; padding:10px 24px 6px 24px; font-size:13px; color:#5a6f85; font-weight:700;">Metrics shown below are for report date: {current_date_display}</td>
                                </tr>
                                <tr>
                                    <td style="display:none; padding:0 24px 8px 24px;">
                                ...
                                <!-- HIDDEN FOR NOW - DO NOT REMOVE -->
                                <tr>
                                    <td style="display:none; padding:8px 24px 4px 24px; color:#1f3f70; font-weight:700; font-size:20px;">Inverter Status</td>
                                </tr>
                                <tr>
                                    <td style="display:none; padding:0 24px 8px 24px; color:#000; font-size:13px;">Expected uptime: 24 hours active during daylight hours</td>
                                </tr>
                                <!-- HIDDEN FOR NOW - DO NOT REMOVE -->
                                <!-- SMB Status section -->
                                <tr>
                                    <td style="display:none; padding:0 24px 14px 24px;">
